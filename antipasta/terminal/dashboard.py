...
from antipasta.terminal.filter_manager import FilterManager
from antipasta.terminal.focus_manager import FocusIndicator, FocusManager
from antipasta.terminal.shortcuts import ShortcutManager
from antipasta.terminal.widgets import (
    CommandItem,
    CommandPalette,
    DetailViewWidget,
    DirectorySelected,
...
class TerminalDashboard(App[None]):
    ...
    def action_filter_complexity(self) -> None:
        ...
        from antipasta.terminal.filter_manager import Filter, FilterType
