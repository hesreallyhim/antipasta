...
class TestHeuristicMetrics(unittest.TestCase):
    ...
    def test_heuristic_metrics_simple_code(self):
...
'''
    ...
    def test_heuristic_metrics_complex_code(self):
...
'''
    ...
    def test_heuristic_metrics_with_classes(self):
...
class TestComputeDiff(unittest.TestCase):
    ...
    def test_compute_diff_all_increases(self):
    ...
    def test_compute_diff_all_decreases(self):
...
class TestEvaluateOperation(unittest.TestCase):
    ...
    def test_evaluate_write_operation_approved(self):
    ...
    def test_evaluate_write_operation_blocked_complexity(self):
...
'''
    ...
    def test_evaluate_edit_operation_approved(self):
...
'''
    ...
    def test_evaluate_multiedit_operation(self):
...
class TestRadonMetrics(unittest.TestCase):
    ...
    def test_radon_metrics_simple_python(self):
...
'''
    ...
    @unittest.skipIf(not RADON_AVAILABLE, "Radon not available")
    def test_radon_metrics_with_class(self):
...
'''
    ...
    def test_radon_metrics_fallback(self):
