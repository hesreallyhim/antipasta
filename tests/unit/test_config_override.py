...
class TestConfigOverride:
    ...
    def test_init_with_values(self) -> None:
        ...
        override = ConfigOverride(
            ...
            threshold_overrides={"cyclomatic_complexity": 15.0},
    ...
    def test_has_overrides(self) -> None:
        ...
        override = ConfigOverride()
        override.threshold_overrides["test"] = 10.0
        assert override.has_overrides()
    ...
    def test_merge_with_config_dict_basic(self) -> None:
        ...
        override = ConfigOverride(
            exclude_patterns=["**/build/**"],
            threshold_overrides={"cyclomatic_complexity": 15},
            disable_gitignore=True,
        )
    ...
    def test_merge_with_config_dict_all_threshold_types(self) -> None:
        ...
        override = ConfigOverride(
            threshold_overrides={
                ...
                "halstead_volume": 2000,
                "halstead_difficulty": 20,
                "halstead_effort": 20000,
            }
        )
