...
def test_file_discovery(project_path: str = "."):
    ...
    visible_dirs = [d for d in all_dirs if d.is_dir() and not d.name.startswith('.')]
    hidden_dirs = [d for d in all_dirs if d.is_dir() and d.name.startswith('.')]
