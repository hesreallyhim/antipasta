"""Snapshot 07: class responsibilities are split into cohesive collaborators."""
...
class InvoiceRenderer:
    ...
    def render_email(self, receipt: dict[str, Any]) -> EmailMessage:
        ...
        message["Subject"] = f"{self.template_name}:{receipt['id']}"
...
class PaymentSummary:
    ...
    def record_payment(self, amounts: list[Any]) -> dict[str, Any]:
